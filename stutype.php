<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action']) && $_POST['action'] == 'add') {
        ...
        if (!empty($student_id) && !empty($student_type)) {
            $insert_sql = "INSERT INTO student_type (student_id, student_type, date) 
    ...
    $sql = "SELECT * FROM student_type ORDER BY id DESC";
    
    if (!empty($search)) {
        $sql = "SELECT * FROM student_type WHERE student_id LIKE '%$search%' OR student_type LIKE '%$search%' ORDER BY id DESC";
    }
    
    // Handle AJAX request for getting student data
    if(isset($_GET['ajax']) && $_GET['ajax'] == 'get_student' && isset($_GET['id'])) {
        $id = intval($_GET['id']);
        $query = "SELECT * FROM student_type WHERE id = $id";
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_GET['ajax']) && $_GET['ajax'] == 'update_student') {
        ...
        $update_sql = "UPDATE student_type SET 
    ...
    <div class="container">
        ...
        <div class="sidebar">
            ...
            <div class="nav-menu">
                ...
                <div class="dropdown-menus" id="studentDropdown">
                    ...
                    <a href="stutype.php" class="nav-item sub-menu active">
        ...
        <div class="main-content">
            ...
            <form method="GET" action="" class="search-box m-2">
                ...
                <?php if(!empty($search)): ?>
                    <a href="student_type.php" class="clear-search"><i class="fas fa-times"></i> Clear</a>
                <?php endif; ?>
            </form>
                            ...
                            while($row = mysqli_fetch_assoc($result)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                        <span class="<?php echo $badgeClass; ?>"><?php echo ucfirst($type); ?></span>
                                    </td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="process_student_type.php" method="POST" id="addStudentForm">
                        <div class="row mb-3">
                            <div class="col-md-6">
                         ...
                         <div class="row mb-3">
                                <label class="form-label">Date Transfer <span class="text-danger">*</span></label>
                ...
                <div class="modal-body">
                    <form id="editStudentForm">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <label class="form-label">Student Type <span class="text-danger">*</span></label>
                                <select id="edit_student_type" name="student_type" class="form-select" required>
                                    <!-- <option value="new">New Student</option> -->
                                    <option value="old">Old Student</option>
                                    <option value="Transfer">Transfer Student</option>
                                </select>

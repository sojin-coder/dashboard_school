...
<div class="container">
    ...
    <div class="main-content">
        ...
        <div class="grid">
            <!-- Card 1: Employee Attendance -->
            <a href="Attendance.php" style="text-decoration: none;">
                <div class="card">
                    <div class="card-img">
                        <img src="https://i.pinimg.com/1200x/40/76/fc/4076fcfe75ac91635549cda45a12fe6a.jpg" alt="Employee Attendance">
                    </div>
                    <div class="body-card">
                        <h1><i class="fas fa-user-tie me-2"></i> Employee Attendance</h1>
                        <div class="college-body">
                            <div class="college-stats">
                                <div class="stat">
                                    <div class="stat-number" id="empTotalCount">--</div>
                                    <div class="stat-label">Total Employee</div>
                                </div>
                                <div class="stat">
                                    <div class="stat-number" id="empMaleCount">--</div>
                                    <div class="stat-label">Male</div>
                                </div>
                                <div class="stat">
                                    <div class="stat-number" id="empFemaleCount">--</div>
                                    <div class="stat-label">Female</div>
                                </div>
                            </div>
                            <div class="view-btn">
                                <i class="fas fa-id-card"></i> Manage Employee Attendance
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <a href="attendanceAll.php" style="text-decoration: none;">
                <div class="card">
                    <div class="card-img">

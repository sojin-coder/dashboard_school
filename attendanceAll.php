...
<div class="container">
    ...
    <div class="main-content">
        ...
        <div class="grid">
            ...
            <a href="attit.php" style="text-decoration: none;">
                <div class="card">
                    <div class="card-img">
            ...
            <a href="attcivil.php" style="text-decoration: none;">
                <div class="card">
                    <div class="card-img">
            ...
            <a href="attElectronics.php" style="text-decoration: none;">
                <div class="card">
                    <div class="card-img">
            ...
            <a href="attBusiness.php" style="text-decoration: none;">
                <div class="card">
                    <div class="card-img">
            ...
            <a href="attElectrical.php" style="text-decoration: none;">
                <div class="card">
                    <div class="card-img">
